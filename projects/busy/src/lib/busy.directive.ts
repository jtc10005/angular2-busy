...
export class BusyDirective implements DoCheck, OnDestroy {
  ...
  private dectectOptionsChange(): boolean {
  ...
  ngDoCheck(): void {
    ...
    if (!this.busyRef
      ...
      if (options.backdrop) { this.createBackdrop(); }
  ...
  private destroyComponents(): void {
    if (this.busyRef) { this.busyRef.destroy(); }
    if (this.backdropRef) { this.backdropRef.destroy(); }
  }
