...
import { IPromiseTrackerOptions } from './interfaces';
...
export class PromiseTrackerService {
  ...
  private addPromise(promise: Promise<any> | Subscription): void {
  ...
  private finishPromise(promise: Promise<any> | Subscription): void {
    // tslint:disable-next-line: no-string-literal
